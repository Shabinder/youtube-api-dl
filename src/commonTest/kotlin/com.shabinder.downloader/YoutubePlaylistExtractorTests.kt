...
internal class YoutubePlaylistExtractorTests : YoutubePlaylistTests() {
    ...
    @Test
    fun shortPlaylistSuccess() = runTest {
    ...
    @Test
    fun playlistWithoutAuthorSuccess() = runTest {
    ...
    // stable
    @Test
    fun longPlaylistSuccess() = runTest {
    ...
    @Test
    fun veryLongPlaylistSuccess() = runTest {
    ...
    @Test
    fun playlistUnavailableThrowsException() = runTest {
